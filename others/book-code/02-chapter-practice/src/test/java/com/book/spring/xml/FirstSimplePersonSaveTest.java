...
public class FirstSimplePersonSaveTest {
    ...
    public void savePersonOne() {
        ...
        //FIXED_TODO 3. Request the "personManager" bean from the context and store it into the Manager variable
        // Use the Manager
        personManager = context.getBean("personManager", PersonManager.class);
