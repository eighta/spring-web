...
public class DiningForm implements Serializable {
	...
	/**
	 * Validates the dining information (credit-card details) entered in the
	...
	public void validateEnterDiningInformation(ValidationContext context) {
		if (StringUtils.hasText(creditCardNumber)) {
			...
			// Note that any 16 digit string is OK here. Whether this card
			// actually exists is handled in the NewRewardActions.
