...
public class AccountSearchController {
	 ...
	 * 
	 * @param criteria
	 *            The search criteria to pre-populate the form with. It is not
	 *            used by the method, but declaring it forces Spring MVC to
	...
	public String processSubmit(@Valid AccountSearchCriteria criteria,
		...
		Logger.getLogger(getClass().getName()).info("Using MVC form-handling controller method.");
	...
	// TODO -06: This is the method you need to invoke using AJAX to query for
	// a list of accounts. It is only invoked if JSON is requested,
	// so we will be using the jQuery getJSON() function. What is the
	// URL to invoke this method? Try entering it manually in your
	// web browser - you will need the .json suffix
	// HINT: The URL will be something like:
	// http://localhost:8080/ajax/some/path.json?searchString=a&maximumResults=5
	/**
