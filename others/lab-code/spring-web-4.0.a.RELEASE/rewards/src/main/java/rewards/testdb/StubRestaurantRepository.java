...
public class StubRestaurantRepository implements RestaurantRepository {
	...
	public List<Restaurant> getAllRestaurants() {
		return new ArrayList<Restaurant>(restaurantsByMerchantNumber.values());
	}

	/**
	 * A simple "dummy" benefit availability policy that always returns true.
	 * Only useful for testing--a real availability policy might consider many
	 * factors such as the day of week of the dining, or the account's reward
