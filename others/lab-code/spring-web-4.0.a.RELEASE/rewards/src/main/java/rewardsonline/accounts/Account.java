 ...
 * beneficiaries whose allocations must add up to 100%. An aggregate DTO.
 * 
...
public class Account implements Serializable {
	 ...
	 * Serialization id
	 */
	private static final long serialVersionUID = -25092677561760599L;
	...
	/**
	 * Required by JPA when used as an entity, used by AccountManagerImpl
	 */
	protected Account() {
	}
