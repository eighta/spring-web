 ...
 */
public class RestaurantTests implements AccountTestConstants {
	...
	public void setUp() {
		...
		account = new Account(ACC_123456789, "Keith and Keri Donald");
		account.addBeneficiary("Annabelle");
		dining = Dining.createDining("100.00", CC_1234123412341234, RESTAURANT_APPLE_BEES);
	}
