...
public class ConsoleStringTable {
    ...
    // XXX NEW
    public void end(){
    	// XXX tratar de implementar completamente 
    	// http://stackoverflow.com/questions/19126629/formatting-a-java-console-table-breaking#answers 
    }
    ...
    public String getTableAsString (int padding) {
        ...
        for (int r= 0; r < _numRows; r++) {
            for (int c= 0; c < _numColumns; c++) {
                ...
                //out+= Strings.padStart(content, columSize + pad, ' ');
